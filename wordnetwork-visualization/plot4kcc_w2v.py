...
def visualization(G,imageFileName):
		...
		# edges
		nx.draw_networkx_edges(G,pos,edgelist=elarge,width=1.5,edge_color='g')
		nx.draw_networkx_edges(G,pos,edgelist=esmall,width=1.5,alpha=0.5,edge_color='b',style='dashed')
